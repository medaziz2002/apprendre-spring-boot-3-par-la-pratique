...
public class ProduitController {
    ...
    @RequestMapping("/supprimerProduit") public String supprimerProduit(@RequestParam("id") Integer id,
                                                                        ModelMap modelMap,
                                                                        @RequestParam (name="page",defaultValue = "0") int page,
                                                                        @RequestParam (name="size", defaultValue = "2") int size)
    {
    ...
    public String editerProduit(@RequestParam("id") Integer id,ModelMap modelMap)
    {
